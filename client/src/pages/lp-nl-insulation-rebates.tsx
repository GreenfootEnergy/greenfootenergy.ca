...
const insulationBenefits = [
  ...
  },
  {
    ...
    description: "Newfoundland & Labrador winters are harsh. Upgraded insulation keeps the cold out and warmth in where it belongs."
  },
  {
    icon: Home,
...
const processSteps = [
  ...
  },
  {
    ...
    description: "We help you navigate the TakeCHARGE rebate program to maximize your savings. Rebates available through the Insulate & Save program."
  },
  {
    step: 3,
    title: "Enjoy Savings",
...
const faqs = [
  {
    question: "What rebates are available for insulation in Newfoundland & Labrador?",
    answer: "The TakeCHARGE Insulate & Save program offers rebates for qualifying insulation upgrades. Our team will help you understand what you qualify for and guide you through the application process."
  },
  {
...
export default function NLInsulationRebatesLP() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      <Helmet>
        <title>Newfoundland Insulation Rebates | TakeCHARGE Up to $2,000</title>
        <meta name="description" content="Claim up to $2,000 with TakeCHARGE Insulate & Save program. Spray foam, blown-in, and batt insulation for Newfoundland & Labrador homes. Free assessment." />
        <link rel="canonical" href="https://greenfootenergy.ca/nl-insulation-rebates" />
        <meta name="keywords" content="TakeCHARGE rebates, Newfoundland insulation, home insulation NL, spray foam St Johns, insulation rebates Newfoundland Labrador" />
        <meta property="og:title" content="Newfoundland Insulation Rebates | TakeCHARGE Up to $2,000" />
        <meta property="og:description" content="Claim up to $2,000 with TakeCHARGE Insulate & Save for spray foam, blown-in, and batt insulation." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://greenfootenergy.ca/nl-insulation-rebates" />
        <meta property="og:image" content="https://greenfootenergy.ca/opengraph.jpg" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Newfoundland Insulation Rebates | TakeCHARGE Up to $2,000" />
        <meta name="twitter:description" content="Claim up to $2,000 with TakeCHARGE insulation rebates in NL. Free assessment available." />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl md:text-2xl font-bold text-[#8dc63f] mb-4">
                CLAIM UP TO $2,000 IN REBATES WITH
              </p>
              ...
              <p className="text-lg text-gray-400 mb-8 max-w-lg">
                Take the first step in making your home more energy efficient. Claim available rebates through the TakeCHARGE program.
              </p>
            ...
            >
              ...
              <div className="space-y-4">
                <a 
                  href="https://scheduling.greenfootenergy.ca/?utm_source=paid_social&utm_medium=meta&utm_campaign=nl_insulation&utm_content=get_assessed_button"
                  target="_blank"
                ...
                <a 
                  href="https://takechargenl.ca/insulate-and-save/"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                >
                  View TakeCHARGE Rebates <ArrowRight className="w-5 h-5" />
                </a>
                <a 
