...
const insulationBenefits = [
  ...
  },
  {
    ...
    description: "Prince Edward Island winters bring biting winds off the Gulf. Upgraded insulation keeps the cold out and warmth in where it belongs."
  },
  {
    icon: Home,
...
const processSteps = [
  ...
  },
  {
    ...
    description: "We help you navigate the efficiencyPEI rebate program to maximize your savings. Rebates available through the Home Insulation Rebates program."
  },
  {
    step: 3,
    title: "Enjoy Savings",
...
const faqs = [
  {
    question: "What rebates are available for insulation in Prince Edward Island?",
    answer: "The efficiencyPEI Home Insulation Rebates program offers rebates for qualifying insulation upgrades. Our team will help you understand what you qualify for and guide you through the application process."
  },
  {
...
export default function PEIInsulationRebatesLP() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      <Helmet>
        <title>PEI Insulation Rebates | efficiencyPEI Home Rebates</title>
        <meta name="description" content="Claim exclusive efficiencyPEI Home Insulation Rebates. Spray foam, blown-in, and batt insulation for Prince Edward Island homes. Free assessment available." />
        <link rel="canonical" href="https://greenfootenergy.ca/pei-insulation-rebates" />
        <meta name="keywords" content="efficiencyPEI rebates, PEI insulation, home insulation Prince Edward Island, spray foam Charlottetown, insulation rebates PEI" />
        <meta property="og:title" content="PEI Insulation Rebates | efficiencyPEI Home Rebates" />
        <meta property="og:description" content="Claim exclusive efficiencyPEI Home Insulation Rebates for spray foam, blown-in, and batt insulation." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://greenfootenergy.ca/pei-insulation-rebates" />
        <meta property="og:image" content="https://greenfootenergy.ca/opengraph.jpg" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="PEI Insulation Rebates | efficiencyPEI Home Rebates" />
        <meta name="twitter:description" content="Claim exclusive efficiencyPEI insulation rebates in Prince Edward Island. Free assessment." />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 bg-[#8dc63f]/20 text-[#8dc63f] px-4 py-2 rounded-full text-sm font-semibold mb-6">
                ...
                efficiencyPEI Rebate Program
              </div>
              
              <p className="text-xl md:text-2xl font-bold text-[#8dc63f] mb-4">
                CLAIM EXCLUSIVE REBATES IN PEI FOR
              </p>
              ...
              <p className="text-lg text-gray-400 mb-8 max-w-lg">
                Take the first step in making your Island home more energy efficient. Claim available rebates through the efficiencyPEI program.
              </p>
            ...
            >
              ...
              <div className="space-y-4">
                <a 
                  href="https://scheduling.greenfootenergy.ca/?utm_source=paid_social&utm_medium=meta&utm_campaign=pei_insulation&utm_content=get_assessed_button"
                  target="_blank"
                ...
                <a 
                  href="https://www.princeedwardisland.ca/en/information/environment-energy-and-climate-action/home-insulation-rebates"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                >
                  View efficiencyPEI Rebates <ArrowRight className="w-5 h-5" />
                </a>
                <a 
              ...
              <a href="/financing" target="_blank" rel="noopener noreferrer" className="block bg-[#8dc63f]/10 border border-[#8dc63f]/30 rounded-xl p-4 mb-6 hover:bg-[#8dc63f]/20 transition-colors mt-6">
