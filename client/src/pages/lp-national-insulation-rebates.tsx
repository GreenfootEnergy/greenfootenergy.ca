...
import { Phone, TrendingDown, Shield, Snowflake, Home, Thermometer, ChevronDown, ArrowRight, Zap, Award, Star, MapPin } from "lucide-react";
...
const insulationBenefits = [
  ...
  },
  {
    ...
    description: "Canadian winters are harsh. Upgraded insulation keeps the cold out and warmth in where it belongs."
  },
  {
    icon: Home,
...
const processSteps = [
  ...
  },
  {
    ...
    description: "We help you navigate your provincial rebate program to maximize your savings. Contact us for province-specific rebate information."
  },
  {
    step: 3,
    title: "Enjoy Savings",
...
const serviceLocations = {
  "Nova Scotia": ["Bridgewater", "Dartmouth", "Kentville", "New Glasgow", "Sydney"],
  "New Brunswick": ["Fredericton", "Moncton", "Saint John", "Tracadie-Sheila"],
  "Newfoundland & Labrador": ["Paradise"],
  "Prince Edward Island": ["Charlottetown"],
  "British Columbia": ["Abbotsford", "Kamloops", "Kelowna", "Langley", "Surrey", "Victoria"]
};

const faqs = [
  {
    question: "What rebates are available for insulation in my province?",
    answer: "Rebate programs vary by province. Nova Scotia offers efficiencyNS rebates, New Brunswick has SaveEnergy NB, Newfoundland has TakeCHARGE, PEI has efficiencyPEI, and British Columbia offers CleanBC rebates. Contact us for specific rebate information in your area."
  },
  {
  ...
  {
    question: "Does Greenfoot serve my area?",
    answer: "We proudly serve communities across Nova Scotia, New Brunswick, Newfoundland & Labrador, Prince Edward Island, and British Columbia. Contact us to confirm service availability in your specific location."
  }
];

export default function NationalInsulationRebatesLP() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      <Helmet>
        <title>Insulation Rebates Canada | Up to $5,500 in Savings</title>
        <meta name="description" content="Claim up to $5,500 in insulation rebates across Canada. Spray foam, blown-in, and batt insulation with provincial rebate programs. Free assessment available." />
        <link rel="canonical" href="https://greenfootenergy.ca/insulation-rebates" />
        <meta name="keywords" content="insulation rebates Canada, home insulation, spray foam insulation, blown-in insulation, energy rebates, Greenfoot Energy" />
        <meta property="og:title" content="Insulation Rebates Canada | Up to $5,500 in Savings" />
        <meta property="og:description" content="Claim up to $5,500 in insulation rebates across Canada. Spray foam, blown-in, and batt insulation services." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://greenfootenergy.ca/insulation-rebates" />
        <meta property="og:image" content="https://greenfootenergy.ca/opengraph.jpg" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Insulation Rebates Canada | Up to $5,500 in Savings" />
        <meta name="twitter:description" content="Claim up to $5,500 in insulation rebates across Canada. Free assessment available." />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 bg-[#8dc63f]/20 text-[#8dc63f] px-4 py-2 rounded-full text-sm font-semibold mb-6">
                ...
                Provincial Rebate Programs Available
              </div>
              
              <p className="text-xl md:text-2xl font-bold text-[#8dc63f] mb-4">
                CLAIM UP TO $5,500 IN REBATES* FOR
              </p>
              ...
              <p className="text-xl text-gray-300 mb-4 font-semibold">
                TAKE THE 1ST STEP IN MAKING YOUR HOME MORE ENERGY EFFICIENT!
              </p>
              
              <p className="text-lg text-gray-400 mb-8 max-w-lg">
                We proudly serve Nova Scotia, New Brunswick, Newfoundland & Labrador, Prince Edward Island, and British Columbia. Contact us for province-specific rebate information.
              </p>
              
              <p className="text-sm text-gray-500 italic">
                *Rebates vary based on province
              </p>
            ...
            >
              ...
              <div className="space-y-4">
                <a 
                  href="https://scheduling.greenfootenergy.ca/?utm_source=paid_social&utm_medium=meta&utm_campaign=national_insulation&utm_content=get_assessed_button"
                  target="_blank"
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h3 className="text-sm font-bold text-[#8dc63f] uppercase mb-2">Invest in Your Home</h3>
              <h2 className="text-3xl md:text-4xl font-black text-[#333333] mb-6 uppercase">
                That Is The <span className="text-[#8dc63f]">Greenfoot Approach!</span>
              </h2>
              ...
              <p className="font-semibold text-[#333333]">
                Expertise you can trust, tailored to your home.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-16 lg:py-20 bg-[#333333]">
        <div className="container mx-auto px-4 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-white mb-6 uppercase">
              Ready to <span className="text-[#8dc63f]">Get Started?</span>
            </h2>
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Take the first step towards a more comfortable, energy-efficient home. Contact us to learn about rebates available in your province.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                href="https://scheduling.greenfootenergy.ca/?utm_source=paid_social&utm_medium=meta&utm_campaign=national_insulation&utm_content=final_cta"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-[#8dc63f] hover:bg-[#709c32] text-white font-bold text-lg px-8 h-14 rounded-xl shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2"
              >
                Get a Free Assessment <ArrowRight className="w-5 h-5" />
              </a>
              <a 
                href="tel:18003809384"
                className="bg-white hover:bg-slate-100 text-[#333333] font-bold text-lg px-8 h-14 rounded-xl shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2"
              >
                <Phone className="w-5 h-5" />
                Call 1 (800) 380-9384
              </a>
