...
const insulationBenefits = [
  ...
  },
  {
    ...
    description: "Nova Scotia winters bring Atlantic cold and coastal winds. Upgraded insulation keeps the cold out and warmth in where it belongs."
  },
  {
    icon: Home,
...
const processSteps = [
  ...
  },
  {
    ...
    description: "We help you navigate the efficiencyNS rebate program to maximize your savings. Rebates available through the Home Insulation Rebates program."
  },
  {
    step: 3,
    title: "Enjoy Savings",
...
const faqs = [
  {
    question: "What rebates are available for insulation in Nova Scotia?",
    answer: "The efficiencyNS Home Insulation Rebates program offers rebates for qualifying insulation upgrades. Our team will help you understand what you qualify for and guide you through the application process."
  },
  {
...
export default function NSInsulationRebatesLP() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      <Helmet>
        <title>Nova Scotia Insulation Rebates | efficiencyNS Up to $1,500</title>
        <meta name="description" content="Claim up to $1,500 with efficiencyNS Home Insulation Rebates. Spray foam, blown-in, and batt insulation for Nova Scotia homes. Free assessment available." />
        <link rel="canonical" href="https://greenfootenergy.ca/ns-insulation-rebates" />
        <meta name="keywords" content="efficiencyNS rebates, Nova Scotia insulation, home insulation NS, spray foam Halifax, insulation rebates Nova Scotia" />
        <meta property="og:title" content="Nova Scotia Insulation Rebates | efficiencyNS Up to $1,500" />
        <meta property="og:description" content="Claim up to $1,500 with efficiencyNS Home Insulation Rebates for spray foam, blown-in, and batt insulation." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://greenfootenergy.ca/ns-insulation-rebates" />
        <meta property="og:image" content="https://greenfootenergy.ca/opengraph.jpg" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Nova Scotia Insulation Rebates | efficiencyNS Up to $1,500" />
        <meta name="twitter:description" content="Claim up to $1,500 with efficiencyNS Home Insulation Rebates. Free assessment available." />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 bg-[#8dc63f]/20 text-[#8dc63f] px-4 py-2 rounded-full text-sm font-semibold mb-6">
                ...
                efficiencyNS Rebate Program
              </div>
              
              <p className="text-xl md:text-2xl font-bold text-[#8dc63f] mb-4">
                CLAIM UP TO $1,500 IN REBATES FOR
              </p>
              ...
              <p className="text-lg text-gray-400 mb-8 max-w-lg">
                Take the first step in making your home more energy efficient. Claim available rebates through the efficiencyNS program.
              </p>
            ...
            >
              ...
              <div className="space-y-4">
                <a 
                  href="https://scheduling.greenfootenergy.ca/?utm_source=paid_social&utm_medium=meta&utm_campaign=ns_insulation&utm_content=get_assessed_button"
                  target="_blank"
                ...
                <a 
                  href="https://www.efficiencyns.ca/tools-and-resources/energy-efficient-products/home-insulation-rebates"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                >
                  View efficiencyNS Rebates <ArrowRight className="w-5 h-5" />
                </a>
                <a 
