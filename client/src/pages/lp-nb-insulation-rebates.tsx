...
const insulationBenefits = [
  ...
  },
  {
    ...
    description: "New Brunswick winters are harsh. Upgraded insulation keeps the cold out and warmth in where it belongs."
  },
  {
    icon: Home,
...
const processSteps = [
  ...
  },
  {
    ...
    description: "We help you navigate the SaveEnergy NB rebate program to maximize your savings. Rebates available through the Total Home Energy Savings program."
  },
  {
    step: 3,
    title: "Enjoy Savings",
...
const faqs = [
  {
    question: "What rebates are available for insulation in New Brunswick?",
    answer: "The SaveEnergy NB Total Home Energy Savings program offers rebates for qualifying insulation upgrades. Our team will help you understand what you qualify for and guide you through the application process."
  },
  {
...
export default function NBInsulationRebatesLP() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      <Helmet>
        <title>New Brunswick Insulation Rebates | SaveEnergy NB Up to $1,750</title>
        <meta name="description" content="Claim up to $1,750 with SaveEnergy NB Total Home Energy Savings. Spray foam, blown-in, and batt insulation for New Brunswick homes. Free assessment." />
        <link rel="canonical" href="https://greenfootenergy.ca/nb-insulation-rebates" />
        <meta name="keywords" content="SaveEnergy NB rebates, New Brunswick insulation, home insulation NB, spray foam Moncton, insulation rebates New Brunswick" />
        <meta property="og:title" content="New Brunswick Insulation Rebates | SaveEnergy NB Up to $1,750" />
        <meta property="og:description" content="Claim up to $1,750 with SaveEnergy NB for spray foam, blown-in, and batt insulation in New Brunswick." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://greenfootenergy.ca/nb-insulation-rebates" />
        <meta property="og:image" content="https://greenfootenergy.ca/opengraph.jpg" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="New Brunswick Insulation Rebates | SaveEnergy NB Up to $1,750" />
        <meta name="twitter:description" content="Claim up to $1,750 with SaveEnergy NB insulation rebates. Free assessment available." />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 bg-[#8dc63f]/20 text-[#8dc63f] px-4 py-2 rounded-full text-sm font-semibold mb-6">
                ...
                SaveEnergy NB Rebate Program
              </div>
              
              <p className="text-xl md:text-2xl font-bold text-[#8dc63f] mb-4">
                CLAIM UP TO $1,750 IN REBATES WITH
              </p>
              ...
              <p className="text-lg text-gray-400 mb-8 max-w-lg">
                Take the first step in making your home more energy efficient. Claim available rebates through the SaveEnergy NB program.
              </p>
            ...
            >
              ...
              <div className="space-y-4">
                <a 
                  href="https://scheduling.greenfootenergy.ca/?utm_source=paid_social&utm_medium=meta&utm_campaign=nb_insulation&utm_content=get_assessed_button"
                  target="_blank"
                ...
                <a 
                  href="https://www.saveenergynb.ca/NBPForms/TotalHomeEnergySavingsw.aspx"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                >
                  View SaveEnergy NB Rebates <ArrowRight className="w-5 h-5" />
                </a>
                <a 
