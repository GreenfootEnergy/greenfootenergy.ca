...
const steps = [
  ...
  },
  {
    ...
    description: "We'll help you navigate the Oil to Electric incentive program.",
...
export default function OilToHeatPumpPage() {
  return (
    <div className="min-h-screen bg-[#fdfdfc] selection:bg-[#8dc63f]/30">
      <Helmet>
        <title>Save Up to $22,000 When You Switch From Oil | Greenfoot Energy</title>
        <meta name="description" content="Save up to $22,000 with the Oil to Electric Incentive Program when you switch from oil to a heat pump. Cover the entire cost of multiple units to suit any home." />
        <meta name="keywords" content="oil to heat pump, oil to electric rebate, $22000 rebate, heat pump incentive, switch from oil, Greenfoot Energy" />
        <link rel="canonical" href="https://www.greenfootenergy.ca/lp/oil-to-heat-pump-rebate-up-to-22k" />
        
        <meta property="og:title" content="Save Up to $22,000 When You Switch From Oil | Greenfoot Energy" />
        <meta property="og:description" content="Qualified homeowners can receive up to $22,000 to transition from oil to electricity-based heat." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.greenfootenergy.ca/lp/oil-to-heat-pump-rebate-up-to-22k" />
        
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Save Up to $22,000 | Oil to Heat Pump Rebate" />
        <meta name="twitter:description" content="Switch from oil heating and save up to $22,000 with the Oil to Electric Incentive Program." />
      </Helmet>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-[1.1] mb-6 tracking-tight">
                Save Up to <span className="text-[#8dc63f]">$22,000*</span> When You Switch From Oil!
              </h1>
              
              <p className="text-xl md:text-2xl text-slate-300 mb-10 max-w-xl leading-relaxed">
                Cover the entire cost of multiple units to suit any home. Qualified homeowners can transition from oil to electricity-based heat.
              </p>
              ...
              <p className="text-sm text-slate-400">*Conditions apply. Available through provincial incentive programs.</p>
            </motion.div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            <p className="text-xl md:text-2xl text-white leading-relaxed mb-8">
              <em>With the <strong className="text-[#8dc63f]">NEW Oil to Electric Incentive Program</strong>, qualified homeowners can receive an incentive up to $22,000* to help transition their homes from oil to electricity-based heat. Conditions apply.</em>
            </p>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-extrabold text-white mb-6">
              Ready to <span className="text-[#8dc63f]">Save Up to $22,000?</span>
            </h2>
